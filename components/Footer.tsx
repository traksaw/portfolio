...
const socialLinks = [
  ...
  },
  {
    ...
    label: "Bluesky",
    icon: (
      <path d="M13.5 11.8c-1.087-2.114-4.046-6.053-6.798-7.995C4.066 1.944 3.061 2.266 2.402 2.565 1.639 2.908 1.5 4.08 1.5 4.768c0 .69.378 5.65.624 6.479.785 2.627 3.593 3.494 6.216 3.065-4.659.79-6.648 3.39-3.744 6.827 3.31 3.921 5.903.81 6.904-2.238.16-.49.25-.79.25-.79s.09.3.25.79c1.001 3.048 3.594 6.159 6.904 2.238 2.904-3.437.915-6.037-3.744-6.827 2.623.429 5.431-.438 6.216-3.065.246-.829.624-5.789.624-6.479 0-.689-.139-1.861-.902-2.203-.659-.3-1.664-.62-4.3 1.24C14.546 5.747 11.587 9.686 10.5 11.8h3z" />
    ),
  },
]
